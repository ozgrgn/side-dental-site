!(function (t, e) {
    ...
    return (function (t) {
            ...
            return (
              ...
              (i.onCreate = function () {
                (i.display = document.createElement("div")),
                  Object.assign(i.display.style, i.options.displayStyles),
              ...
              (i.onUpdate = function () {
                if (i.display && i.img) {
                  ...
                  if (
                    ((i.display.innerHTML = t.join(" &times; ")),
                    t[0] > 120 && t[1] > 30)
                  )
              ...
              (i.getCurrentSize = function () {
                return [
                  i.img.width,
                  Math.round(
                    (i.img.width / i.img.naturalWidth) * i.img.naturalHeight
                  ),
                ];
              }),
              (a = n),
          ...
          function e() {
            ...
            return (
              ...
              (i.positionBoxes = function () {
                var t =
                    -parseFloat(i.options.handleStyles.width) / 2 + "px",
              ...
              (i.handleMouseup = function () {
                i.setCursor(""),
                  document.removeEventListener("mousemove", i.handleDrag),
                  document.removeEventListener("mouseup", i.handleMouseup);
              }),
              (i.handleDrag = function (t) {
                if (i.img) {
                  var e = t.clientX - i.dragStartX;
                  i.dragBox === i.boxes[0] || i.dragBox === i.boxes[3]
                    ? (i.img.width = Math.round(i.preDragWidth - e))
                    : (i.img.width = Math.round(i.preDragWidth + e)),
                    i.requestUpdate();
                }
              }),
                ...
                (i._addToolbarButtons = function () {
                  ...
                  i.alignments.forEach(function (e, n) {
                    ...
                    t.push(o),
                      ...
                      Object.assign(
                        o.children[0].style,
                        i.options.toolbarButtonSvgStyles
                      ),
      ...
      function (t, e, n) {
        ...
        (e.default = f),
          window.Quill && window.Quill.register("modules/imageResize", f);
      },
      function (t, e, n) {
        function o(t) {
          var e = -1,
      ...
      function (t, e, n) {
        function o(t) {
          return r(function (e, n) {
            ...
            for (
              a =
                t.length > 3 && "function" == typeof a ? (r--, a) : void 0,
                s &&
                  i(n[0], n[1], s) &&
                  ((a = r < 3 ? void 0 : a), (r = 1)),
                e = Object(e);
      ...
      function (t, e, n) {
        function o(t, e, n, a, s, u) {
          return (
            i(t) &&
              i(e) &&
              (u.set(e, t), r(t, e, void 0, o, u), u.delete(e)),
            t
          );
        }
        var r = n(19),
